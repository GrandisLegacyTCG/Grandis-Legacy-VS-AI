# Grandis Legacy VS AI v6.43 + Tutorial v0.68

This repository contains the Grandis Legacy local **VS AI v6.43** application and **Tutorial v0.68**. Candidate **(10)** consumes **Grandis Legacy Source Authority v1.9.5** and keeps canonical gameplay authority outside the application repository.
