...
for(const rel of ['shared-app/app.bundle.js','js/app.bundle.js','tutorial/js/app.bundle.js']){
  ...
  must(s.includes('v642TabletLandscapePreviewSize')&&s.includes('vw*.2625')&&s.includes('vh*.625'),'Tablet Landscape ~25% enlarged viewport-relative preview sizing missing in '+rel);
