...
assert(index.includes('js/app.bundle.js?v=gl-vs-ai-6.21'),'v6.14 app bundle cache revision missing');
...
console.log('PASS VS AI v6.21 Game Result Back to Lobby + 60-second auto-return silent reload');
