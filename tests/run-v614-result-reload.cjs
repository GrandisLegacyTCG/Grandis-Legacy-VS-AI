...
assert.strictEqual(pkg.version,'6.43.0');
...
assert(index.includes('shared-app/app.bundle.js?v=gl-vs-ai-643-lobby'),'current v6.43 shared app source cache revision missing');
