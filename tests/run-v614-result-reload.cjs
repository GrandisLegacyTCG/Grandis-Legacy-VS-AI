...
assert.strictEqual(pkg.version,'6.44.0');
...
assert(index.includes('shared-app/app.bundle.js?v=gl-vs-ai-644-ai-lobby-card-presentation'),'current v6.43 shared app source cache revision missing');
