...
assert.strictEqual(pkg.version,'6.45.0');
...
assert(index.includes('shared-app/app.bundle.js?v=gl-vs-ai-645-opponent-hand-ai-reposition'),'current v6.43 shared app source cache revision missing');
...
console.log('PASS VS AI v6.25 Game Result Back to Lobby + 60-second auto-return silent reload');
