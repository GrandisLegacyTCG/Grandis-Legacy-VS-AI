...
need(app.includes('Grandis Legacy VS AI v5.47'),'v5.47 application label missing');
...
assert.strictEqual(pkg.version,'5.47.0');
console.log('PASS v5.47 Android/mobile visual fixes');
