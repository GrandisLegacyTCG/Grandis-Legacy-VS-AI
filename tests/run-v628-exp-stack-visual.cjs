...
console.log('PASS VS AI v6.31 / Tutorial v0.57: transparent master 100/200 EXP sprite, fixed four-slot rail, and rail height synchronized to the visible Hero artwork.');
