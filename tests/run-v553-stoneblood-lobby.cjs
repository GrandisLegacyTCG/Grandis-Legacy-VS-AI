...
assert(app.includes('Grandis Legacy VS AI v5.58'),'VS AI v5.58 marker missing');
...
console.log('PASS VS AI v5.58 Stoneblood continuation and AI Lobby compact title alignment');
