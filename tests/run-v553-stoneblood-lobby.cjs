...
assert(app.includes('Grandis Legacy VS AI v5.60'),'current VS AI marker missing');
...
console.log('PASS VS AI v5.60 Stoneblood continuation and AI Lobby compact title alignment');
