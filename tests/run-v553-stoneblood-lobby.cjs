...
assert(app.includes('Grandis Legacy VS AI v5.56'),'VS AI v5.56 marker missing');
...
console.log('PASS VS AI v5.56 Stoneblood continuation and AI Lobby compact title alignment');
