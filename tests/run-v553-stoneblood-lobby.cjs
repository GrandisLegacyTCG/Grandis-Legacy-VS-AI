...
assert(app.includes('Grandis Legacy VS AI v5.63'),'current VS AI marker missing');
...
console.log('PASS VS AI v5.63 Stoneblood continuation and AI Lobby compact title alignment');
