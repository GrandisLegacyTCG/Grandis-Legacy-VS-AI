...
assert(app.includes('Grandis Legacy VS AI v5.57'),'VS AI v5.57 marker missing');
...
console.log('PASS VS AI v5.57 Stoneblood continuation and AI Lobby compact title alignment');
