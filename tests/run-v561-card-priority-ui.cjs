...
need(html.includes('gl-vs-ai-6.2'),'VS AI v6.2 cache revision missing');
need(app.includes('Grandis Legacy VS AI v6.2'),'VS AI v6.2 runtime version missing');
need(data.includes('"local_ai":"v6.1"')&&data.includes('"pvp_railway":"v3.02"')&&data.includes('"deck_builder":"v1.8"'),'App source stack versions missing');
