...
need(html.includes('gl-vs-ai-5.62'),'VS AI v5.62 cache revision missing');
need(app.includes('Grandis Legacy VS AI v5.62'),'VS AI v5.62 runtime version missing');
need(data.includes('"local_ai":"v5.62"')&&data.includes('"pvp_railway":"v2.6.18"')&&data.includes('"deck_builder":"v1.6"'),'App source stack versions missing');
...
console.log('PASS VS AI v5.62 card-priority desktop UI lock');
