...
need(app.includes('Grandis Legacy VS AI v6.10'),'VS AI v6.2 runtime version missing');
need(data.includes('"local_ai":"v6.9"')&&data.includes('"pvp_railway":"v3.07"')&&data.includes('"deck_builder":"v1.8"'),'App source stack versions missing');
