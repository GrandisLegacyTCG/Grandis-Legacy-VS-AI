...
assert(/gl-vs-ai-645-opponent-hand-ai-reposition/.test(rootIndex),'root VS AI v6.44 shared Lobby cache-buster missing');
assert(/gl-shared-v645-068/.test(tutorialIndex),'Tutorial shared-app cache-buster must follow regenerated v6.44 shared bytes');
