...
must(index.includes('gl-vs-ai-5.62'),'v5.62 cache revision missing');
...
console.log('PASS VS AI v5.62 right-side Tutorial navigation and Mage setup-to-Attack planning.');
