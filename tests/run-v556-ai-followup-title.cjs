...
must(index.includes('gl-vs-ai-6.3'),'v6.1 cache revision missing');
...
console.log('PASS VS AI v6.1 right-side Tutorial navigation and Mage setup-to-Attack planning.');
