...
must(index.includes('gl-vs-ai-6.10'),'v6.9 cache revision missing');
...
console.log('PASS VS AI v6.10 right-side Tutorial navigation and Mage setup-to-Attack planning.');
