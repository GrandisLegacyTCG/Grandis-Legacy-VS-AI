...
must(index.includes('gl-vs-ai-5.63'),'v5.62 cache revision missing');
...
console.log('PASS VS AI v5.63 right-side Tutorial navigation and Mage setup-to-Attack planning.');
