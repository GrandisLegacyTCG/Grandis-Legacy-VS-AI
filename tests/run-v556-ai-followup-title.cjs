...
must(index.includes('gl-vs-ai-5.58'),'v5.58 cache revision missing');
...
console.log('PASS VS AI v5.58 right-side Tutorial navigation and Mage setup-to-Attack planning.');
