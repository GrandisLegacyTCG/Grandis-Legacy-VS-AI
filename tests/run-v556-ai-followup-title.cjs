...
must(index.includes('gl-vs-ai-5.61'),'v5.61 cache revision missing');
...
console.log('PASS VS AI v5.61 right-side Tutorial navigation and Mage setup-to-Attack planning.');
