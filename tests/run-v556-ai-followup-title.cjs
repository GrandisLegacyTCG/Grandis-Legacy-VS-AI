...
must(index.includes('gl-vs-ai-6.0'),'v6.0 cache revision missing');
...
console.log('PASS VS AI v6.0 right-side Tutorial navigation and Mage setup-to-Attack planning.');
