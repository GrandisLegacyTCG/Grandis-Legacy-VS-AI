...
must(index.includes('gl-vs-ai-5.60'),'v5.60 cache revision missing');
...
console.log('PASS VS AI v5.60 right-side Tutorial navigation and Mage setup-to-Attack planning.');
