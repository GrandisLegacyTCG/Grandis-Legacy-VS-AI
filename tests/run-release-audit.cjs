...
const lock=json('sync/runtime-sync-lock.v2.31.json');assert.strictEqual(lock.canonical_registry_hash,H);assert.strictEqual(lock.application_runtime_sync,'v2.31');assert.strictEqual(lock.local_ai,'v5.46');
...
console.log('PASS VS AI v5.46 release audit: Casting survives Draw/Rank Up, release uses current Hero, response hover diagnostics, mobile resources, and desktop cleanup.');
