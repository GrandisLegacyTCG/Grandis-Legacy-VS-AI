...
const lock=json('sync/runtime-sync-lock.v2.48.json');assert.strictEqual(lock.canonical_registry_hash,H);assert.strictEqual(lock.hero_component_registry_hash,HH);assert.strictEqual(lock.application_runtime_sync,'v2.48');assert.strictEqual(lock.local_ai,'v6.15');
