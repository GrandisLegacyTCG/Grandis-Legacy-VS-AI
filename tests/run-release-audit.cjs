...
const lock=json('sync/runtime-sync-lock.v2.26.json');assert.strictEqual(lock.canonical_registry_hash,H);assert.strictEqual(lock.application_runtime_sync,'v2.26');assert.strictEqual(lock.local_ai,'v5.41');
...
console.log('PASS VS AI v5.41 release audit: response diagnostics, Deck Builder v2.1, straight mobile hands, compact mobile Hero indicators, and current runtime/card assets.');
