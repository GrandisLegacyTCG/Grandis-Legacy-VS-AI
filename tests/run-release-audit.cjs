...
assert.ok(fs.existsSync(path.join(root,'assets/exp/Stack-100-EXP.png'))&&fs.existsSync(path.join(root,'assets/exp/Stack-200-EXP.png')),'physical EXP strip assets');
...
console.log('PASS VS AI v6.27 release audit: Source Stack v1.7.4, Response commit/payment framework, Hero Components, runtime locks, and preserved UI contracts.');
