...
if(!css.includes('.v96-app .gl-app{padding-bottom:3px!important')||!css.includes('html.gl-mobile-game-scroll-active #app::after'))throw new Error('mobile footer/scroll-room contract missing');
