...
if(!r||!r.ok)throw new Error('v5.45 final fixes QA failed '+JSON.stringify(r));
...
console.log('PASS Grandis Legacy VS AI v5.45 final fixes');console.log(JSON.stringify(r));
