...
assert.strictEqual(lock.tutorial,'v0.45');
assert.strictEqual(lock.pvp_reference,'v3.14');
...
console.log('PASS Application Runtime Sync v2.50 VS AI v6.17 source/deploy lock');
