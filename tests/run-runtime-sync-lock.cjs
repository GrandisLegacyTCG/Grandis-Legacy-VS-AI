...
assert.strictEqual(lock.local_ai,'v6.17');
assert.strictEqual(lock.tutorial,'v0.48');
assert.strictEqual(lock.pvp_reference,'v3.17');
...
console.log('PASS Application Runtime Sync v2.50 VS AI v6.20 / Tutorial v0.48 consumer lock on v6.17 gameplay authority');
