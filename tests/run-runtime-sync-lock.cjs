...
assert.strictEqual(lock.local_ai,'v6.24');
assert.strictEqual(lock.tutorial,'v0.52');
assert.strictEqual(lock.pvp_reference,'v3.22');
...
console.log('PASS Application Runtime Sync v2.51 VS AI v6.24 source/deploy lock');
