...
assert.strictEqual(lock.local_ai,'v6.26');
assert.strictEqual(lock.tutorial,'v0.52');
...
console.log('PASS Application Runtime Sync v2.52 VS AI v6.26 source/deploy lock');
