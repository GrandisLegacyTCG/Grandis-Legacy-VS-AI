...
assert.strictEqual(lock.tutorial,'v0.47');
assert.strictEqual(lock.pvp_reference,'v3.16');
...
console.log('PASS Application Runtime Sync v2.50 VS AI v6.19 / Tutorial v0.47 consumer lock on v6.17 gameplay authority');
