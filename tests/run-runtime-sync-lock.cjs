...
const lock=JSON.parse(fs.readFileSync(path.join(root,'sync/runtime-sync-lock.v2.41.json'),'utf8'));
...
assert.strictEqual(lock.application_runtime_sync,'v2.41');
...
assert.strictEqual(lock.local_ai,'v5.54');
console.log('PASS Application Runtime Sync v2.41 VS AI v5.54 source/deploy lock');
