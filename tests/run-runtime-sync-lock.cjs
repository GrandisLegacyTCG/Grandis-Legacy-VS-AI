...
assert.strictEqual(lock.local_ai,'v6.22');
assert.strictEqual(lock.tutorial,'v0.50');
assert.strictEqual(lock.pvp_reference,'v3.19');
...
console.log('PASS Application Runtime Sync v2.51 VS AI v6.22 source/deploy lock');
