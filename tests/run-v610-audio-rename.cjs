...
assert.strictEqual(require('../package.json').version, '6.10.0');
assert.strictEqual(require('../tutorial/package.json').version, '0.41.0');
console.log('PASS VS AI v6.10 + Tutorial v0.41 audio rename: exact bytes, safe space-bearing URLs, and zero stale executable references.');
