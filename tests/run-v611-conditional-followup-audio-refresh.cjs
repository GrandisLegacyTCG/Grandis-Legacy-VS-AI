...
const hash = 'eb89ea56f2351f093fffbd7f7e47628f1cf0cd2b793c6efdfb82c9c9e798b868';
...
assert.ok(!vsBundle.includes("document.addEventListener('touchmove'"), 'VS AI must not cancel native mobile touchmove');
...
assert.strictEqual(require('../package.json').version, '6.30.0');
assert.strictEqual(require('../tutorial/package.json').version, '0.56.0');
