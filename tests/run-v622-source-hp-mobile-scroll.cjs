...
assert.strictEqual(require('../package.json').version,'6.31.0');assert.strictEqual(require('../tutorial/package.json').version,'0.57.0');
console.log('PASS v6.23/v0.51 Source Stack v1.7.5 Hero HP + permanent #app mobile scroll contract');
