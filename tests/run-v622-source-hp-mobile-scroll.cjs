...
const data=require('../data/season1/cards.runtime.v0.14.3.json');
...
assert.strictEqual(require('../package.json').version,'6.30.0');assert.strictEqual(require('../tutorial/package.json').version,'0.56.0');
console.log('PASS v6.23/v0.51 Source Stack v1.7.4 Hero HP + permanent #app mobile scroll contract');
