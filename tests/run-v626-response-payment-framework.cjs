...
console.log('PASS VS AI v6.26: SGH and Escape Arrow use one generic Confirm -> close Response -> mandatory payment -> new counter-Response hierarchy, including exact-instance self exclusion.');
