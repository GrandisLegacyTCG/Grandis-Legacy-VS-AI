...
function loadLocalAI(root){
  ...
  for(const file of ['shared-ui/battlefield-ui.js','js/static-data.js','js/runtime-authority.js','shared-app/active-starters.js','js/app.bundle.js']){
