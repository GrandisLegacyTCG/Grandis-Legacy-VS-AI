...
need(app.includes('Grandis Legacy VS AI v5.49'),'v5.49 application label missing');
...
need(css.includes('Grandis Legacy VS AI v5.49 — mobile Legacy control anchor consistency'),'v5.49 CSS lock missing');
...
assert.strictEqual(pkg.version,'5.49.0');
console.log('PASS v5.49 mobile Legacy control anchor consistency');
