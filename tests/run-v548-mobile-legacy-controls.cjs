...
need(app.includes('Grandis Legacy VS AI v5.60'),'current application label missing');
...
assert.strictEqual(pkg.version,'5.60.0');
console.log('PASS v5.60 mobile Legacy control anchor consistency');
