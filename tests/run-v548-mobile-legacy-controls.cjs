...
need(app.includes('Grandis Legacy VS AI v5.57'),'v5.52 application label missing');
...
need(css.includes('Grandis Legacy VS AI v5.57 — mobile Legacy control anchor consistency'),'v5.52 CSS lock missing');
...
assert.strictEqual(pkg.version,'5.57.0');
console.log('PASS v5.57 mobile Legacy control anchor consistency');
