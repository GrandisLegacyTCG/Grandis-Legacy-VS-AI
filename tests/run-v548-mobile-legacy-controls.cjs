...
need(app.includes('Grandis Legacy VS AI v5.58'),'v5.52 application label missing');
...
assert.strictEqual(pkg.version,'5.58.0');
console.log('PASS v5.58 mobile Legacy control anchor consistency');
