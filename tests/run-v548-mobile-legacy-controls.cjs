...
need(app.includes('Grandis Legacy VS AI v6.4'),'current application label missing');
...
assert.strictEqual(pkg.version,'6.4.0');
console.log('PASS v6.1 mobile Legacy control anchor consistency');
