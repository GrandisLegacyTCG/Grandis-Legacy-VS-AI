...
need(app.includes('Grandis Legacy VS AI v5.62'),'current application label missing');
...
need(css.includes('Grandis Legacy VS AI v5.58 — mobile Legacy control anchor consistency'),'v5.52 CSS lock missing');
...
assert.strictEqual(pkg.version,'5.62.0');
console.log('PASS v5.62 mobile Legacy control anchor consistency');
