...
need(app.includes('Grandis Legacy VS AI v6.10'),'current application label missing');
...
assert.strictEqual(pkg.version,'6.10.0');
console.log('PASS v6.9 mobile Legacy control anchor consistency');
