...
need(app.includes('Grandis Legacy VS AI v5.48'),'v5.48 application label missing');
...
need(css.includes('Grandis Legacy VS AI v5.48 — mobile Legacy control anchor consistency'),'v5.48 CSS lock missing');
...
assert.strictEqual(pkg.version,'5.48.0');
console.log('PASS v5.48 mobile Legacy control anchor consistency');
