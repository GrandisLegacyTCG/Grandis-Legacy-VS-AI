...
need(app.includes('Grandis Legacy VS AI v5.63'),'current application label missing');
...
assert.strictEqual(pkg.version,'5.63.0');
console.log('PASS v5.63 mobile Legacy control anchor consistency');
