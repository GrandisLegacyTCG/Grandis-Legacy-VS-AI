...
need(app.includes('Grandis Legacy VS AI v5.61'),'current application label missing');
...
assert.strictEqual(pkg.version,'5.61.0');
console.log('PASS v5.61 mobile Legacy control anchor consistency');
