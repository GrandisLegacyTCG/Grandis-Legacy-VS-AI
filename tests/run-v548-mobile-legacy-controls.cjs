...
need(app.includes('Grandis Legacy VS AI v5.50'),'v5.50 application label missing');
...
need(css.includes('Grandis Legacy VS AI v5.50 — mobile Legacy control anchor consistency'),'v5.50 CSS lock missing');
...
assert.strictEqual(pkg.version,'5.50.0');
console.log('PASS v5.50 mobile Legacy control anchor consistency');
