...
for(const [k,v] of Object.entries({runtime_foundation:'v1.81',runtime_core:'v0.49',shared_manual:'v1.37',local_ai:'v5.53',pvp_railway:'v2.6.12',application_runtime_sync:'v2.40'}))if(st[k]!==v)throw new Error(k+'='+st[k]);
...
console.log('PASS VS AI v5.53 source adoption');
