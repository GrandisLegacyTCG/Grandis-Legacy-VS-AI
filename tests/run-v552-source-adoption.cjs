...
for(const [k,v] of Object.entries({runtime_foundation:'v1.91',runtime_core:'v0.59',shared_manual:'v1.47',local_ai:'v6.31',pvp_railway:'v3.39',application_runtime_sync:'v2.53',response_commit_payment_framework:'v1.0'}))if(st[k]!==v)throw new Error(k+'='+st[k]);
...
if(!reducer.__test||typeof reducer.__test.racialResponseIdentity!=='function'||typeof reducer.__test.selectedTargetIsItemUserAndHost!=='function')throw new Error('Core v0.59 test exports missing');
console.log('PASS VS AI v6.31 Source Stack v1.7.5 adoption');
