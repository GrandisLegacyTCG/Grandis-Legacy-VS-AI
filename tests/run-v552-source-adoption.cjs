...
for(const [k,v] of Object.entries({runtime_foundation:'v1.80',runtime_core:'v0.48',shared_manual:'v1.36',local_ai:'v5.52',pvp_railway:'v2.6.11',application_runtime_sync:'v2.39'}))if(st[k]!==v)throw new Error(k+'='+st[k]);
...
if(!reducer.__test||typeof reducer.__test.racialResponseIdentity!=='function'||typeof reducer.__test.selectedTargetIsItemUserAndHost!=='function')throw new Error('Core v0.48 test exports missing');
console.log('PASS VS AI v5.52 source adoption');
