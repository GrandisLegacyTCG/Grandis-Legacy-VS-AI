...
for(const [k,v] of Object.entries({runtime_foundation:'v1.81',runtime_core:'v0.49',shared_manual:'v1.37',local_ai:'v5.54',pvp_railway:'v2.6.13',application_runtime_sync:'v2.41'}))if(st[k]!==v)throw new Error(k+'='+st[k]);
...
console.log('PASS VS AI v5.54 source adoption');
