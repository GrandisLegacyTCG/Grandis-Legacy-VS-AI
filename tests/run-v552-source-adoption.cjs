...
for(const [k,v] of Object.entries({runtime_foundation:'v1.90',runtime_core:'v0.58',shared_manual:'v1.46',local_ai:'v6.30',pvp_railway:'v3.38',application_runtime_sync:'v2.52',response_commit_payment_framework:'v1.0'}))if(st[k]!==v)throw new Error(k+'='+st[k]);
...
console.log('PASS VS AI v6.30 Source Stack v1.7.4 adoption');
