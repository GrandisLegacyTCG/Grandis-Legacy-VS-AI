...
Tutorial v0.68 is paired with **VS AI v6.42** and consumes the same current **OSA v1.9.4 / Starter Deck Authority v1.6.1 / Shared Runtime v1.94.2 / UI Contract v2.53** baseline.
...
- Effect Recipe / Checkpoint v0.15.1 / v0.15.1
- Hero Components v1.1.0
- Starter Deck Authority v1.6.1 — exactly 5 active Starter Decks
- Application Runtime Sync v2.62
- Canonical cards: 200

Candidate (9) consumes the OSA v1.9.4 Attachment lifecycle correction, including Triple Shot's authority-defined This-Turn counter-1 End-Phase expiry, while preserving no physical Arrow-card binding. Tutorial gameplay/runtime behavior stays synchronized with VS AI.
