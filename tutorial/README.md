...
Tutorial v0.68 is paired with **VS AI v6.42** and consumes the same current **OSA v1.9.3 / Starter Deck Authority v1.6.1 / Shared Runtime v1.94.1 / UI Contract v2.53** baseline.
