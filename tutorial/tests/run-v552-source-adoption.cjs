...
if(!reducer.__test||typeof reducer.__test.racialResponseIdentity!=='function'||typeof reducer.__test.selectedTargetIsItemUserAndHost!=='function')throw new Error('Core v0.56 test exports missing');
