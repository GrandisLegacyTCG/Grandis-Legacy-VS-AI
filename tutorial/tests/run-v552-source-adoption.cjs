...
for(const [k,v] of Object.entries({runtime_foundation:'v1.91',runtime_core:'v0.59',shared_manual:'v1.47',local_ai:'v6.31',pvp_railway:'v3.39',application_runtime_sync:'v2.53'}))if(st[k]!==v)throw new Error(k+'='+st[k]);
