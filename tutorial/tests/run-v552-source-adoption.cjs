...
for(const [k,v] of Object.entries({runtime_foundation:'v1.82',runtime_core:'v0.50',shared_manual:'v1.39',local_ai:'v6.1',pvp_railway:'v3.02',application_runtime_sync:'v2.44'}))if(st[k]!==v)throw new Error(k+'='+st[k]);
...
console.log('PASS VS AI v6.1 tutorial-base source adoption');
