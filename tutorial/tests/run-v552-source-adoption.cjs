...
for(const [k,v] of Object.entries({runtime_foundation:'v1.81',runtime_core:'v0.49',shared_manual:'v1.38',local_ai:'v5.60',pvp_railway:'v2.6.17',application_runtime_sync:'v2.43'}))if(st[k]!==v)throw new Error(k+'='+st[k]);
...
console.log('PASS VS AI v5.60 tutorial-base source adoption');
