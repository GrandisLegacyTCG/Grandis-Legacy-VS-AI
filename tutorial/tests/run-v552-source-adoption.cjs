...
for(const [k,v] of Object.entries({runtime_foundation:'v1.86',runtime_core:'v0.54',shared_manual:'v1.42',local_ai:'v6.11',pvp_railway:'v3.09',application_runtime_sync:'v2.48'}))if(st[k]!==v)throw new Error(k+'='+st[k]);
...
if(!reducer.__test||typeof reducer.__test.racialResponseIdentity!=='function'||typeof reducer.__test.selectedTargetIsItemUserAndHost!=='function')throw new Error('Core v0.54 test exports missing');
console.log('PASS VS AI v6.11 tutorial-base source adoption');
