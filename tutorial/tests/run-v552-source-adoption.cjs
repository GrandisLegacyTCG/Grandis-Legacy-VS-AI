...
for(const [k,v] of Object.entries({runtime_foundation:'v1.82',runtime_core:'v0.50',shared_manual:'v1.39',local_ai:'v6.0',pvp_railway:'v3.00',application_runtime_sync:'v2.44'}))if(st[k]!==v)throw new Error(k+'='+st[k]);
...
if(!reducer.__test||typeof reducer.__test.racialResponseIdentity!=='function'||typeof reducer.__test.selectedTargetIsItemUserAndHost!=='function')throw new Error('Core v0.50 test exports missing');
console.log('PASS VS AI v6.0 tutorial-base source adoption');
