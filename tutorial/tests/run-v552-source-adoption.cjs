...
for(const [k,v] of Object.entries({runtime_foundation:'v1.85',runtime_core:'v0.53',shared_manual:'v1.41',local_ai:'v6.9',pvp_railway:'v3.07',application_runtime_sync:'v2.47'}))if(st[k]!==v)throw new Error(k+'='+st[k]);
...
console.log('PASS VS AI v6.10 tutorial-base source adoption');
