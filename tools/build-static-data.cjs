...
const V={osa:'v1.9.4',sharedRuntime:'v1.94.2',runtimeData:'v0.16.1',recipe:'v0.15.1',checkpoint:'v0.15.1',hero:'v1.1.0',starter:'v1.6.1',ui:'v2.53',sync:'v2.62',vsai:'v6.42',tutorial:'v0.68'};
...
function buildActiveStarters(runtime){
  ...
  if(src.source_authority!=='v1.9.4'||src.starter_authority_version!=='v1.6.1'||src.application_runtime_sync!=='v2.62')throw Error('Active starter consumer metadata must be OSA v1.9.4 / Starter v1.6.1 / Sync v2.62');
  ...
  const payload={schema_version:src.schema_version,active_starter_count:5,composition_authority:src.composition_authority,source_authority:'v1.9.4',starter_authority_version:'v1.6.1',application_runtime_sync:'v2.62',canonical_registry_hash:src.canonical_registry_hash,ids:expected};
...
function build(){
 ...
 const runtime=stableCards(), recipes=j('data/season1/effect-recipes.runtime.v0.15.1.json'), hero=j('data/season1/hero-components.runtime.v1.1.0.json');
 ...
 const stack={source_authority:V.osa,shared_runtime:V.sharedRuntime,runtime_data:V.runtimeData,effect_recipe:V.recipe,effect_checkpoint:V.checkpoint,hero_components:V.hero,starter60:V.starter,active_application_starters:'OSA v1.9.4 / Starter Deck Authority v1.6.1 (unchanged compositions)',active_starter_count:5,ui_contract:V.ui,application_runtime_sync:V.sync,vs_ai:V.vsai,tutorial:V.tutorial,canonical_registry_hash:CARD_HASH,hero_component_registry_hash:HERO_HASH,card_count:200,authority_mode:'OSA_CONSUMER_FAIL_CLOSED'}; write('data/config/active-runtime-source-stack.v1.94.json',JSON.stringify(stack,null,2)+'\n');
 ...
 for(const f of ['cards.runtime.v0.16.1.json','effect-recipes.runtime.v0.15.1.json','effect-checkpoint.v0.15.1.json','hero-components.runtime.v1.1.0.json','gameplay-authority.runtime.v1.9.0.json','card-preview.generated.v1.6.0.json','legality-map.runtime.v1.6.0.json'])copy('data/season1/'+f,'tutorial/data/season1/'+f); copy('data/config/active-runtime-source-stack.v1.94.json','tutorial/data/config/active-runtime-source-stack.v1.94.json'); write('tutorial/js/static-data.js',out); copy('js/runtime-authority.js','tutorial/js/runtime-authority.js');
 syncSharedApplicationMirrors();
 syncRuntimeMirror();
 console.log('PASS: OSA v1.9.4 / Shared Runtime v1.94.2 / UI v2.53 -> VS AI v6.42 + Tutorial v0.68; 5 unchanged starters / 200 canonical cards.');
}
build();
