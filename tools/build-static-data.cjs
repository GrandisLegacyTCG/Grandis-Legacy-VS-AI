...
function buildFor(targetRoot) {
  ...
  const profile = rootProfile ? {
    ...
    localAI: 'v6.27', deckBuilder: 'v1.29 (external; permissive save/export, match legality enforced by consumers)', date: '2026-09-07'
  } : {
...
buildFor('.');
buildFor('tutorial');
console.log('PASS: VS AI v6.27 regenerated from Source Stack v1.7.4; Tutorial v0.53 preserves its v1.7.3 gameplay source baseline.');
