...
const V={osa:'v1.9.5',sharedRuntime:'v1.94.2',runtimeData:'v0.16.2',recipe:'v0.15.2',checkpoint:'v0.15.2',hero:'v1.1.0',starter:'v1.6.1',ui:'v2.53',sync:'v2.63',vsai:'v6.43',tutorial:'v0.68'};
...
function build(){
 ...
 syncRuntimeMirror();
 console.log('PASS: OSA v1.9.5 / Shared Runtime v1.94.2 / UI v2.53 -> VS AI v6.43 + Tutorial v0.68; 5 unchanged starters / 200 canonical cards.');
}
build();
