...
function buildFor(targetRoot) {
  ...
  const profile = rootProfile ? {
    ...
    localAI: 'v6.26', deckBuilder: 'v1.29 (external; permissive save/export, match legality enforced by consumers)', date: '2026-09-05'
  } : {
...
buildFor('.');
buildFor('tutorial');
console.log('PASS: VS AI v6.26 regenerated from Source Stack v1.7.4; Tutorial v0.52 preserved on its v1.7.3 source baseline.');
