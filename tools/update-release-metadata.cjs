...
const rootLock={
 version:'v2.52',schema_version:'2.52-consumer',policy:'RUNTIME_FIRST_FAIL_CLOSED_SYNC',application:'VS AI v6.26',local_ai:'v6.26',tutorial:'v0.52',pvp_reference:'v3.38',
 ...
 audio_assets:{coin_flip:{path:'assets/audio/Coin Flip.mp3',sha256:sha('assets/audio/Coin Flip.mp3')},card_sound:{path:'assets/audio/Card Sound.mp3',sha256:sha('assets/audio/Card Sound.mp3')}},
 consumerAdoptionStatus:{currentApplicationsRebuiltInThisDelivery:true,currentAI:'VS AI v6.26',currentPvP:'PvP v3.38 authoritative consumer',currentTutorial:'Tutorial v0.52 GitHub Pages (unchanged)',revisedSeason1:'ADOPTED',heroComponents:'ADOPTED',responseCommitPaymentFramework:'ADOPTED'},
...
const tutorialLock={
 version:'v0.52',tutorial:'v0.52',delivery:'GitHub Pages',base_vs_ai:'v6.24',runtime_foundation:'v1.89',runtime_core:'v0.57',runtime_data:'v0.14.2',effect_recipe:'v0.13.2',legality_map:'v0.11.9',hero_component_authority:'v1.0.0',canonical_registry_hash:TUTORIAL_HASH,hero_component_registry_hash:HERO_HASH,ui_design_lock:'v2.49',scope:'Tutorial v0.52 remains on its prior VS AI v6.24 / Source Stack v1.7.3 gameplay baseline; no Tutorial gameplay change in this delivery.',
 app_bundle_sha256:sha('tutorial/js/app.bundle.js'),tutorial_guide_sha256:sha('tutorial/js/tutorial-guide.js'),tutorial_css_sha256:sha('tutorial/css/tutorial-guide.css'),runtime_authority_sha256:sha('tutorial/js/runtime-authority.js'),static_data_sha256:sha('tutorial/js/static-data.js'),audio_assets:{coin_flip:{path:'assets/audio/Coin Flip.mp3',sha256:sha('tutorial/assets/audio/Coin Flip.mp3')},card_sound:{path:'assets/audio/Card Sound.mp3',sha256:sha('tutorial/assets/audio/Card Sound.mp3')}}
};
writeJSON('tutorial/sync/tutorial-github-lock.v0.52.json',tutorialLock);
for(const old of ['tutorial/sync/tutorial-github-lock.v0.51.json','tutorial/sync/tutorial-github-lock.v0.42.json','tutorial/sync/tutorial-github-lock.v0.41.json','tutorial/sync/tutorial-github-lock.v0.40.json']){const f=path.join(ROOT,old);if(fs.existsSync(f))fs.unlinkSync(f);}
console.log('PASS: VS AI v6.26 Source Stack v1.7.4 release lock updated; Tutorial v0.52 lock preserved.');
