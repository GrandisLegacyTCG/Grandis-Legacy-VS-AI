...
const OSA_RUNTIME_TREE_HASH='87d65f125bbe840649be5daa6f4e0f7a85ec2ec16469820f844405a1608f4a6e';
...
const shared={
  source_authority:'v1.9.4',canonical_card_authority:'v1.6.0',shared_runtime:'v1.94.2',runtime_data:'v0.16.1',effect_recipe:'v0.15.1',effect_checkpoint:'v0.15.1',hero_component_authority:'v1.1.0',starter60:'v1.6.1',starter_deck_authority:'v1.6.1',ui_contract:'v2.53',application_runtime_sync:'v2.62',canonical_registry_hash:H,hero_component_registry_hash:HH,publicResourceTerminology:terminology
};
...
const rootLock={
  schema:'GL-APPLICATION-RUNTIME-SYNC-2.62-CONSUMER',version:'v2.62',date:'2026-09-21',policy:'REFERENCE_OSA_CANONICAL_AUTHORITY_DO_NOT_REDEFINE',
  ...shared,
  ...
  current_authority_status:'OSA v1.9.4 / Starter Deck Authority v1.6.1 / Shared Runtime v1.94.2 / UI Contract v2.53',playtest_lab_v014:'HISTORICAL_ONLY_NOT_ACTIVE_AUTHORITY'
};
...
write('sync/runtime-sync-lock.v2.62.json',rootLock);
...
console.log('PASS: current runtime sync v2.62 and Tutorial v0.68 consumer locks regenerated for OSA v1.9.4 / Shared Runtime v1.94.2 / UI v2.53.');
