...
const rootLock={
 version:'v2.52',schema_version:'2.52-consumer',policy:'RUNTIME_FIRST_FAIL_CLOSED_SYNC',application:'VS AI v6.30',local_ai:'v6.30',tutorial:'v0.56',pvp_reference:'v3.38',
 ...
 audio_assets:{coin_flip:{path:'assets/audio/Coin Flip.mp3',sha256:sha('assets/audio/Coin Flip.mp3')},card_sound:{path:'assets/audio/Card Sound.mp3',sha256:sha('assets/audio/Card Sound.mp3')}}, exp_stack_assets:{master:{path:'assets/exp/Stack 100-200EXP.png',sha256:sha('assets/exp/Stack 100-200EXP.png'),sprite_halves:{left:100,right:200}}},
 consumerAdoptionStatus:{currentApplicationsRebuiltInThisDelivery:true,currentAI:'VS AI v6.30',currentPvP:'PvP v3.38 authoritative consumer',currentTutorial:'Tutorial v0.56 GitHub Pages (orientation-aware EXP Exhaust presentation update)',revisedSeason1:'ADOPTED',heroComponents:'ADOPTED',responseCommitPaymentFramework:'ADOPTED'},
...
const tutorialLock={
 version:'v0.56',tutorial:'v0.56',delivery:'GitHub Pages',base_vs_ai:'v6.24',runtime_foundation:'v1.89',runtime_core:'v0.57',runtime_data:'v0.14.2',effect_recipe:'v0.13.2',legality_map:'v0.11.9',hero_component_authority:'v1.0.0',canonical_registry_hash:TUTORIAL_HASH,hero_component_registry_hash:HERO_HASH,ui_design_lock:'v2.49',scope:'Tutorial v0.56 keeps the prior VS AI v6.24 / Source Stack v1.7.3 gameplay baseline; Ready EXP remains on the Hero right edge, while Exhausted EXP moves above the Hero and stacks bottom-to-top.',
 app_bundle_sha256:sha('tutorial/js/app.bundle.js'),tutorial_guide_sha256:sha('tutorial/js/tutorial-guide.js'),tutorial_css_sha256:sha('tutorial/css/tutorial-guide.css'),runtime_authority_sha256:sha('tutorial/js/runtime-authority.js'),static_data_sha256:sha('tutorial/js/static-data.js'),audio_assets:{coin_flip:{path:'assets/audio/Coin Flip.mp3',sha256:sha('tutorial/assets/audio/Coin Flip.mp3')},card_sound:{path:'assets/audio/Card Sound.mp3',sha256:sha('tutorial/assets/audio/Card Sound.mp3')}}, exp_stack_assets:{master:{path:'assets/exp/Stack 100-200EXP.png',sha256:sha('tutorial/assets/exp/Stack 100-200EXP.png'),sprite_halves:{left:100,right:200}}}
};
writeJSON('tutorial/sync/tutorial-github-lock.v0.56.json',tutorialLock);
for(const old of ['tutorial/sync/tutorial-github-lock.v0.55.json','tutorial/sync/tutorial-github-lock.v0.54.json','tutorial/sync/tutorial-github-lock.v0.53.json','tutorial/sync/tutorial-github-lock.v0.52.json','tutorial/sync/tutorial-github-lock.v0.51.json','tutorial/sync/tutorial-github-lock.v0.42.json','tutorial/sync/tutorial-github-lock.v0.41.json','tutorial/sync/tutorial-github-lock.v0.40.json']){const f=path.join(ROOT,old);if(fs.existsSync(f))fs.unlinkSync(f);}
console.log('PASS: VS AI v6.30 / Tutorial v0.56 orientation-aware EXP stack release locks updated; gameplay Source Stack baselines preserved.');
