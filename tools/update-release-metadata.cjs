...
const rootLock={
 version:'v2.52',schema_version:'2.52-consumer',policy:'RUNTIME_FIRST_FAIL_CLOSED_SYNC',application:'VS AI v6.29',local_ai:'v6.29',tutorial:'v0.55',pvp_reference:'v3.38',
 ...
 consumerAdoptionStatus:{currentApplicationsRebuiltInThisDelivery:true,currentAI:'VS AI v6.29',currentPvP:'PvP v3.38 authoritative consumer',currentTutorial:'Tutorial v0.55 GitHub Pages (visual-only EXP Exhaust-follow update)',revisedSeason1:'ADOPTED',heroComponents:'ADOPTED',responseCommitPaymentFramework:'ADOPTED'},
...
const tutorialLock={
 version:'v0.55',tutorial:'v0.55',delivery:'GitHub Pages',base_vs_ai:'v6.24',runtime_foundation:'v1.89',runtime_core:'v0.57',runtime_data:'v0.14.2',effect_recipe:'v0.13.2',legality_map:'v0.11.9',hero_component_authority:'v1.0.0',canonical_registry_hash:TUTORIAL_HASH,hero_component_registry_hash:HERO_HASH,ui_design_lock:'v2.49',scope:'Tutorial v0.55 keeps the prior VS AI v6.24 / Source Stack v1.7.3 gameplay baseline; this delivery keeps the physical four-slot Tribute EXP presentation and makes the EXP rail rotate with the Hero on Exhaust.',
...
writeJSON('tutorial/sync/tutorial-github-lock.v0.55.json',tutorialLock);
for(const old of ['tutorial/sync/tutorial-github-lock.v0.54.json','tutorial/sync/tutorial-github-lock.v0.53.json','tutorial/sync/tutorial-github-lock.v0.52.json','tutorial/sync/tutorial-github-lock.v0.51.json','tutorial/sync/tutorial-github-lock.v0.42.json','tutorial/sync/tutorial-github-lock.v0.41.json','tutorial/sync/tutorial-github-lock.v0.40.json']){const f=path.join(ROOT,old);if(fs.existsSync(f))fs.unlinkSync(f);}
console.log('PASS: VS AI v6.29 / Tutorial v0.55 visual EXP stack release locks updated; gameplay Source Stack baselines preserved.');
