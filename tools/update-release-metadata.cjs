...
const shared={
  ...
  source_stack_bundle:'v1.8.1',one_source_authority:'v1.8.1',runtime_foundation:'v1.93',runtime_core:'v0.61',
  runtime_data:'v0.15.0',effect_recipe:'v0.14.0',effect_checkpoint:'v0.14.0',legality_map:'v1.5.0',
  hero_component_authority:'v1.0.0',shared_runtime_manual:'v1.49',application_runtime_sync:'v2.56',starter60:'v1.5',ui_design_lock:'v2.51',
...
const rootLock={
  schema:'GL-APPLICATION-RUNTIME-SYNC-2.56',version:'v2.56',policy:'RUNTIME_FIRST_FAIL_CLOSED_SYNC',date:'2026-09-13',
  ...
  requiredSourceStack:{sourceAuthorityStack:'1.8.1',oneSourceAuthority:'1.8.1',runtimeData:'0.15.0',effectCheckpoint:'0.14.0',effectRecipe:'0.14.0',legalityMap:'1.5.0',runtimeCore:'0.61',runtimeFoundation:'1.93',heroComponentAuthority:'1.0.0',uiLock:'2.51',sharedManual:'1.49',starter60:'1.5',applicationRuntimeSync:'2.56'},
  gameplayAuthority:'Playtest Lab v0.14 / Source Stack v1.8.1',authorityVerified:true,
  authorityStatement:'Source Stack v1.8.1 with Playtest v0.14 gameplay promotion. VS AI v6.33 and Tutorial v0.59 use Shard Deck / Shard Pool terminology; Tutorial v0.59 adds explicit Shard-system teaching.',
  stableApplications:{vsAI:'v6.33',tutorial:'v0.59'},publicResourceTerminology:terminology,
  ...shared,local_ai:'v6.33',tutorial:'v0.59',pvp_reference:'v3.40',
  ...
  consumerAdoptionStatus:{currentApplicationsRebuiltInThisDelivery:true,currentAI:'VS AI v6.33',currentTutorial:'Tutorial v0.59',sourceStack:'v1.8.1',playtestV014Promotion:'ADOPTED',publicResourceTerminology:'ADOPTED'},
...
write('sync/runtime-sync-lock.v2.56.json',rootLock);
const tutorialLock={
  schema:'GL-TUTORIAL-GITHUB-LOCK-0.59',version:'v0.59',tutorial:'v0.59',delivery:'GitHub Pages',base_vs_ai:'v6.33',date:'2026-09-13',
  ...shared,scope:'Tutorial v0.59 shares Source Stack v1.8.1 / Playtest Lab v0.14 gameplay with VS AI v6.33 and explicitly teaches Shard Deck, Shard Pool, Mana Shard, Class Shard, Starting Shards, Mana Regen, return cycle, Ultimate-derived Class Shards, and matching-Class-Shard Ultimate Tribute.',
...
write('tutorial/sync/tutorial-github-lock.v0.59.json',tutorialLock);
console.log('PASS: VS AI v6.33 / Tutorial v0.59 release locks updated for Source Stack v1.8.1 and Shard terminology.');
