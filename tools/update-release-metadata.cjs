...
const rootLock={
 version:'v2.52',schema_version:'2.52-consumer',policy:'RUNTIME_FIRST_FAIL_CLOSED_SYNC',application:'VS AI v6.28',local_ai:'v6.28',tutorial:'v0.54',pvp_reference:'v3.38',
 ...
 consumerAdoptionStatus:{currentApplicationsRebuiltInThisDelivery:true,currentAI:'VS AI v6.28',currentPvP:'PvP v3.38 authoritative consumer',currentTutorial:'Tutorial v0.54 GitHub Pages (visual-only EXP stack update)',revisedSeason1:'ADOPTED',heroComponents:'ADOPTED',responseCommitPaymentFramework:'ADOPTED'},
...
const tutorialLock={
 version:'v0.54',tutorial:'v0.54',delivery:'GitHub Pages',base_vs_ai:'v6.24',runtime_foundation:'v1.89',runtime_core:'v0.57',runtime_data:'v0.14.2',effect_recipe:'v0.13.2',legality_map:'v0.11.9',hero_component_authority:'v1.0.0',canonical_registry_hash:TUTORIAL_HASH,hero_component_registry_hash:HERO_HASH,ui_design_lock:'v2.49',scope:'Tutorial v0.54 keeps the prior VS AI v6.24 / Source Stack v1.7.3 gameplay baseline; this delivery adds only the physical four-slot Tribute EXP presentation.',
...
writeJSON('tutorial/sync/tutorial-github-lock.v0.54.json',tutorialLock);
for(const old of ['tutorial/sync/tutorial-github-lock.v0.53.json','tutorial/sync/tutorial-github-lock.v0.52.json','tutorial/sync/tutorial-github-lock.v0.51.json','tutorial/sync/tutorial-github-lock.v0.42.json','tutorial/sync/tutorial-github-lock.v0.41.json','tutorial/sync/tutorial-github-lock.v0.40.json']){const f=path.join(ROOT,old);if(fs.existsSync(f))fs.unlinkSync(f);}
console.log('PASS: VS AI v6.28 / Tutorial v0.54 visual EXP stack release locks updated; gameplay Source Stack baselines preserved.');
