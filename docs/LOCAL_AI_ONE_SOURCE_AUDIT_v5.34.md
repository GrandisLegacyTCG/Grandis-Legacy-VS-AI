# Local AI One Source and Runtime Audit — carried forward through VS AI v5.45

This audit is carried forward with the current VS AI gameplay/runtime stack.

- Runtime Foundation v1.76, Runtime Core v0.43, Runtime Data v0.12.5, Effect Recipe v0.11.5, and Legality v0.11.4 are the active executable gameplay authority for VS AI v5.45.
...
- v5.45 changes Casting source continuity across Rank Up/Draw and release-time source evaluation. Canonical card data and PvP remain unchanged.
