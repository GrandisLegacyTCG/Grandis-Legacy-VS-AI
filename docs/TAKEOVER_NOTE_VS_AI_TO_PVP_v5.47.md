...
- Desktop UI from VS AI v5.45 is treated as the approved baseline except the Response Window refinements in v5.46 and the mobile visual/input refinements in v5.47.
...
## D. Packages synchronized by VS AI v5.47
...
- Application Runtime Sync v2.32
- UI Design Lock Pack v2.35
